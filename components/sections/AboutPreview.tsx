...
export function AboutPreview() {
  return (
    <Box component="section" className="py-28 bg-ink-900">
      <Box className="max-w-7xl mx-auto px-6 lg:px-10">
        <Box className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <AnimatedContainer direction="left" className="relative">
            <Box className="aspect-[4/5] rounded-sm overflow-hidden">
              <Image
            ...
            {/* Year badge */}
            <Box className="absolute -bottom-5 -right-5 bg-gold text-ink-950 px-6 py-4 rounded-sm">
              <Box className="font-serif text-3xl font-bold leading-none">1977</Box>
              <Box className="text-[10px] font-semibold tracking-[0.15em] uppercase mt-1">Established</Box>
            </Box>
          </AnimatedContainer>

          {/* Text */}
          <AnimatedContainer direction="right">
            <Typography component="p" className="text-[11px] tracking-[0.2em] uppercase text-gold mb-4">About Us</Typography>
            <Typography variant="h2" component="h2" className="font-serif text-4xl md:text-5xl text-sand font-bold mb-6 leading-tight">
              A Legacy Built on Glass
            </Typography>
            <Typography component="span" className="gold-line mb-8 block" />
            <Box className="space-y-4 text-ink-200 text-[15px] leading-relaxed mb-10">
            ...
            <Box className="grid grid-cols-2 gap-6 mb-10">
              {[
                ...
                <Box key={text} className="border-l border-gold/30 pl-4">
                  <Box className="font-serif text-xl text-gold font-bold">{num}</Box>
                  <Box className="text-[12px] text-ink-300 tracking-wide mt-0.5">{text}</Box>
                </Box>
              ))}
            </Box>
            <Link
