...
export function ProjectGallery() {
  ...
  return (
    <Box component="section" className="py-28 bg-surface-dark relative overflow-hidden">
      ...
      <Box className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <AnimatedContainer className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-14">
          <Box>
            <Typography component="span" className="section-kicker mb-4 block">Portfolio</Typography>
            <Typography variant="h2" component="h2" className="font-serif text-4xl md:text-5xl text-white font-bold tracking-tight">
              Featured Projects
            </Typography>
          </Box>
            ...
            {filtered.map((p, i) => (
              ...
              <Box className="absolute inset-x-0 bottom-0 p-8 flex flex-col justify-end translate-y-8 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                <Box className="flex items-center justify-between mb-4">
                  <Typography component="span" className="text-[10px] font-bold tracking-[0.3em] uppercase text-gold block">
                    {p.category}
                  </Typography>
