...
export function Footer() {
  return (
    <footer className="bg-surface-dark border-t border-white/10 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">

        {/* Top grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-ink-800/50">
          ...
          <div className="space-y-5 lg:col-span-1">
            ...
            <p className="text-ink-300 text-sm leading-relaxed max-w-xs font-medium">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-bold tracking-[0.15em] text-[10px] uppercase mb-6 text-gold">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-bold tracking-[0.15em] text-[10px] uppercase mb-6 text-gold">Our Services</h3>
            <ul className="space-y-3.5">
              {[
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold tracking-[0.15em] text-[10px] uppercase mb-6 text-gold">Contact</h3>
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-start gap-2.5 text-sm text-ink-300 hover:text-gold transition-colors duration-200 font-medium leading-relaxed group"
                >
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-ink-300 text-xs text-center md:text-left font-medium">
            &copy; {new Date().getFullYear()} {SITE_NAME}. All rights reserved.
          </p>

          {/* Built with love attribution */}
          <p className="flex items-center gap-1.5 text-xs text-ink-300 font-medium">
            Built with
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 text-xs text-ink-300">
