        ...
        <Box className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-ink-800/50">
          ...
          <Box className="space-y-5 lg:col-span-1">
            <Link href="/" className="inline-block">
              <Typography component="span" className="font-serif text-xl font-bold tracking-tight text-white">
                Rajendra <Typography component="span" className="text-gold">Glass House</Typography>
              </Typography>
            </Link>
