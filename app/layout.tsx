...
const schemaOrg = {
  ...
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "Glass & Mirror Products & Services in Coimbatore",
    "itemListElement": [
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Toughened Glass Supply & Installation" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Tempered Glass Coimbatore" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Frameless Shower Enclosures" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Glass Railing Installation" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Office Glass Partitions" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "LED Mirror Installation" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Bathroom Mirror Supply" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Custom Glass Cutting in Coimbatore" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Float Glass Supply Tamil Nadu" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Decorative & Lacquered Glass" } },
    ],
  },
}
