...
export const PHONE = "+919889882014";
export const PHONE_DISPLAY = "+91 98898 82014";
...
export const CONTACT_INFO = {
  address: "Sir Shanmugam Road, R.S. Puram, Coimbatore – 641 002, Tamil Nadu",
  phone: PHONE_DISPLAY,
  email: "info@rajendraglasshouse.com",
};
